...
local ConvarClass = {}
ConvarClass.HookLabel = "TTT2CountercurseMantraHookLabel"
ConvarClass.UlxLabel = "TTT2CountercurseMantraUlxLabel"
...
--Countercurse Mantra ConVars
local countercurse_mantra_cfg = ConvarGroup("Countercurse Mantra", "Countercurse Mantra for TTT2")
Convar(countercurse_mantra_cfg, false, "ttt2_countercurse_mantra_armor", "15", {FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY, FCVAR_ARCHIVE}, "How much armor should the Countercurse Mantra provide?", "int", 0, 100, 0)
